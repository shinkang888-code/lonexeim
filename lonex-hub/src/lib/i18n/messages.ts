...
const ko: Messages = {
  ...
  dashboard: {
    greeting: "업무 허브에 오신 것을 환영합니다",
    subtitle: "모듈형 기업 앱을 한곳에서 실행하고 관리하세요",
    searchPlaceholder: "앱 이름·기능 검색…",
    modules: "모듈",
    connected: "OSS 연동",
    quickOs: "OS Shell",
    quickOsSub: "데스크톱형 업무 환경",
    quickAi: "AI 서비스",
    quickAiSub: "LogShield · HF 추론",
    searchResults: "검색 결과",
...
const en: Messages = {
  ...
  dashboard: {
    greeting: "Welcome to your work hub",
    subtitle: "Launch and manage modular enterprise apps in one place",
    searchPlaceholder: "Search apps…",
    modules: "modules",
    connected: "OSS linked",
    quickOs: "OS Shell",
    quickOsSub: "Desktop-style workspace",
    quickAi: "AI Services",
    quickAiSub: "LogShield · HF inference",
...
const ja: Messages = {
  ...
  dashboard: {
    greeting: "ワークハブへようこそ",
    subtitle: "モジュール型エンタープライズアプリを一元管理",
    searchPlaceholder: "アプリを検索…",
    modules: "モジュール",
    connected: "OSS連携",
    quickOs: "OS Shell",
    quickOsSub: "デスクトップ型ワークスペース",
    quickAi: "AIサービス",
    quickAiSub: "LogShield · HF推論",
    searchResults: "検索結果",
    noResults: "該当するアプリがありません。",
    appsCount: "{count}アプリ",
  },
  categories: {
...
const id: Messages = {
  ...
  dashboard: {
    greeting: "Selamat datang di hub kerja",
    subtitle: "Jalankan dan kelola aplikasi enterprise modular di satu tempat",
    searchPlaceholder: "Cari aplikasi…",
    modules: "modul",
    connected: "OSS terhubung",
    quickOs: "OS Shell",
    quickOsSub: "Ruang kerja gaya desktop",
    quickAi: "Layanan AI",
    quickAiSub: "LogShield · inferensi HF",
    searchResults: "Hasil pencarian",
    noResults: "Tidak ada aplikasi yang cocok.",
...
const vi: Messages = {
  ...
  dashboard: {
    greeting: "Chào mừng đến hub công việc",
    subtitle: "Khởi chạy và quản lý ứng dụng doanh nghiệp modular tại một nơi",
    searchPlaceholder: "Tìm ứng dụng…",
    modules: "module",
    connected: "OSS đã liên kết",
    quickOs: "OS Shell",
    quickOsSub: "Không gian làm việc kiểu desktop",
    quickAi: "Dịch vụ AI",
    quickAiSub: "LogShield · suy luận HF",
    searchResults: "Kết quả tìm kiếm",
    noResults: "Không có ứng dụng phù hợp.",
    appsCount: "{count} ứng dụng",
  },
  categories: {
